...
const experiences = [
  {
    ...
    period: '2023 – Present',
    description: 'Leading development of enterprise web applications using Next.js and React Native. Architected microservices serving 100k+ users.',
    achievements: [
  ...
  },
  {
    ...
    location: 'Riyadh, Saudi Arabia',
    period: '2021 – 2023',
    description: 'Built and deployed multiple client-facing web and mobile applications. Specialized in React ecosystems and backend APIs.',
    achievements: [
  ...
  },
  {
    ...
    location: 'Remote',
    period: '2020 – 2021',
    description: 'Developed cross-platform mobile applications using React Native. Collaborated with design and product teams.',
    achievements: [
  ...
  },
  {
    ...
    period: '2019 – 2020',
    description: 'Started professional career in IT engineering, managing infrastructure and developing internal tools.',
    achievements: [
      'Automated manual processes saving 20+ hours per week',
      'Managed server infrastructure for 200+ employees',
      'Developed internal dashboard for IT asset management',
    ],
